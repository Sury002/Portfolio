...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "A modern recipe explorer with search, filtering, detailed recipes, and favorites functionality with dark mode support.",
    ...
    },
    {
      ...
      description:
        "A responsive chatbot powered by GPT-3.5/4.0 via OpenRouter API, featuring secure serverless backend.",
      icon: "fas fa-robot",
    ...
    },
    {
      ...
      description:
        "Interactive movie search application that fetches data from OMDB API with filtering capabilities.",
      icon: "fas fa-film",
    ...
    },
    {
      ...
      description:
        "A financial tracking application to monitor income and expenses with visual charts and reports.",
      icon: "fas fa-wallet",
